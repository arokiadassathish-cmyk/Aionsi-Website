...
export const evidenceDetails: Record<string, EvidenceDetail> = {
  'reusable-uvm-verification-architecture': makeDetail({
    ...
    context: [
      'Reusable verification infrastructure helps reduce repeated environment development and maintain consistent verification patterns across programs.',
      'The architecture connects reusable agents and stimulus with checking, coverage, assertions and regression analysis for structured verification closure.',
    ],
  ...
  'pcie-5-data-link-layer-verification': makeDetail({
    ...
    context: [
      'Data Link Layer verification requires focused checking of transaction reliability, acknowledgement behavior, replay handling and flow-control conditions.',
      'A structured environment combines stimulus, protocol checking, assertions and coverage to exercise normal and error conditions.',
    ],
  ...
  'hbm4e-memory-subsystem-verification': makeDetail({
    ...
    context: [
      'Memory subsystem verification spans controller behavior, PHY interaction, training sequences and integration with memory models.',
      'Verification requires coordinated stimulus, checking, coverage and automated regression across subsystem interfaces and operating scenarios.',
    ],
  ...
  'processor-based-verification-arm-cortex-m7': makeDetail({
    ...
    context: [
      'Processor-driven verification validates hardware behavior through software-visible interactions rather than relying only on directed HDL-level stimulus.',
      'The approach is useful for exercising initialization, register access, memory behavior and interrupt-driven scenarios at subsystem level.',
    ],
  ...
  'formal-verification-cadence-jaspergold': makeDetail({
    ...
    context: [
      'Formal methods can complement simulation by targeting structural properties and corner conditions that benefit from exhaustive or property-based analysis.',
      'A planned formal flow identifies suitable properties, assumptions, proof objectives and integration points with the broader verification strategy.',
    ],
  ...
  '5g-radio-on-chip-functional-verification': makeDetail({
    ...
    context: [
      'Radio-oriented SoC subsystems require coordinated verification of datapath behavior, software-visible control and algorithmic reference behavior.',
      'A mixed methodology can combine reusable UVM infrastructure, reference-model correlation, scoreboarding and formal planning within one verification flow.',
    ],
  ...
  'end-to-end-iot-soc-verification': makeDetail({
    ...
    context: [
      'End-to-end SoC verification must connect IP-level verification with subsystem integration and final system-level scenarios.',
      'The flow requires consistent environments, third-party IP integration, RTL and gate-level verification, regression and evidence-based closure.',
    ],
  ...
  'ufs-4-low-power-verification': makeDetail({
    ...
    context: [
      'Low-power interface verification requires checking state transitions, clock behavior, reset sequencing and power-management control across defined operating scenarios.',
      'UVM-based stimulus and checking can be combined with coverage and regression to evaluate low-power behavior systematically.',
    ],
