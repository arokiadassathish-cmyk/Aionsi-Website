...
export const capabilities: Capability[] = [
  ...
  {
    slug: 'design-verification', number: '02', title: 'Design Verification', description: 'Verification expertise across block, subsystem and SoC levels.', technologies: ['SystemVerilog', 'UVM', 'Coverage', 'Assertions'], outcome: 'Coverage-driven verification confidence', evidenceStatus: 'ready-to-populate',
    evidence: [
  ...
  {
    slug: 'physical-design', number: '03', title: 'Physical Design', description: 'Physical implementation, timing closure and physical verification across complex silicon programs from netlist through sign-off.', technologies: ['Floorplanning', 'Placement', 'CTS', 'Routing', 'PrimeTime STA', 'Calibre / ICV'], outcome: 'Signoff-ready implementation', evidenceStatus: 'ready-to-populate',
    evidence: [
  ...
  {
    slug: 'protocol-verification', number: '05', title: 'Protocol Verification', description: 'Protocol-focused verification for complex semiconductor interfaces.', technologies: ['PCIe', 'USB', 'DDR', 'HBM', 'AMBA'], outcome: 'Interface-level verification confidence', evidenceStatus: 'ready-to-populate',
    evidence: [
