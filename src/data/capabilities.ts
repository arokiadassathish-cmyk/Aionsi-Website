...
export const capabilities: Capability[] = [
  ...
  },
  {
    ...
    description: 'Engineering across processor, interconnect, memory, high-speed protocol IP and SoC integration.',
    technologies: ['RISC-V', 'AMBA CHI / AXI', 'PCIe Gen6', 'DDR4 / DDR5', 'HBM2e / HBM3', 'USB 3.x / USB4'],
    outcome: 'Integration-ready IP, subsystem and SoC delivery', evidenceStatus: 'ready-to-populate',
    evidence: [
      { title: 'RISC-V Processor Core Family', type: 'architecture', description: 'Aionsi processor portfolio spanning embedded through performance and multi-core cluster tiers, with RV32/RV64 support, optional Vector/Floating-Point/Crypto extensions and AXI/CHI integration.', href: '/evidence/risc-v-processor-core-family' },
      { title: 'AMBA CHI & AXI Interconnect Fabrics', type: 'architecture', description: 'Aionsi CHI and AXI fabric portfolio covering coherent multi-core interconnect, QoS, configurable topologies, monitoring and heterogeneous SoC integration.', href: '/evidence/amba-chi-axi-interconnect-fabrics' },
      { title: 'PCIe Gen6 Data Link Layer', type: 'architecture', description: 'PCIe Gen6 DLL IP covering LTSSM, flow control, packet processing, error detection/recovery, power management and Gen3–Gen6 compatibility.', href: '/evidence/pcie-gen6-data-link-layer' },
      { title: 'DDR4 & DDR5 Memory Controllers', type: 'architecture', description: 'Memory-controller portfolio covering command scheduling, PHY abstraction, refresh management, SECDED/Chipkill ECC, RAS and multi-channel configurations.', href: '/evidence/ddr4-ddr5-memory-controllers' },
      { title: 'HBM2e & HBM3 Memory Controllers', type: 'architecture', description: 'High-bandwidth memory controller portfolio covering multi-channel arbitration, QoS-aware scheduling, thermal management, AXI/CHI interfaces and HBM protocol validation.', href: '/evidence/hbm2e-hbm3-memory-controllers' },
      { title: 'USB 3.x & USB4 Controllers', type: 'architecture', description: 'USB controller portfolio covering PHY/link/protocol layers, link training, power delivery, error recovery and host/device integration.', href: '/evidence/usb-3x-usb4-controllers' },
    ],
  },
];
