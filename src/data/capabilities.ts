...
export const capabilities: Capability[] = [
  {
    ...
    description: 'RTL engineering across block, subsystem and SoC development.', technologies: ['Verilog', 'SystemVerilog', 'RTL Design'], outcome: 'Integration-ready RTL', evidenceStatus: 'ready-to-populate',
  },
  {
    slug: 'design-verification', number: '02', title: 'Design Verification',
    description: 'Verification expertise across block, subsystem and SoC levels.', technologies: ['SystemVerilog', 'UVM', 'Coverage', 'Assertions'], outcome: 'Coverage-driven verification confidence', evidenceStatus: 'ready-to-populate',
    evidence: [
  ...
  },
  {
    ...
    description: 'Physical implementation, timing closure and physical verification across complex silicon programs from netlist through sign-off.', technologies: ['Floorplanning', 'Placement', 'CTS', 'Routing', 'PrimeTime STA', 'Calibre / ICV'], outcome: 'Signoff-ready implementation', evidenceStatus: 'ready-to-populate',
    evidence: [
  ...
  },
  {
    ...
    description: 'Design-for-test engineering integrated into the silicon lifecycle.', technologies: ['Test Architecture', 'Scan', 'ATPG'], outcome: 'Manufacturing-test readiness', evidenceStatus: 'ready-to-populate',
    evidence: [{ title: 'DFT Sign-off Methodology for Mixed-Signal IP', type: 'whitepaper', description: 'Scan chain debugging, ATPG pattern generation, fault coverage, Gate-Level Simulation, IEEE 1149.x boundary scan, CTL generation and DFT sign-off methodology.', href: '/evidence/dft-signoff-methodology-mixed-signal-ip' }],
  },
  {
    slug: 'protocol-verification', number: '05', title: 'Protocol Verification',
    description: 'Protocol-focused verification for complex semiconductor interfaces.', technologies: ['PCIe', 'USB', 'DDR', 'HBM', 'AMBA'], outcome: 'Interface-level verification confidence', evidenceStatus: 'ready-to-populate',
    evidence: [
  ...
  },
  {
    ...
    description: 'Engineering across IP integration, subsystem development and SoC integration.', technologies: ['IP', 'Subsystem', 'SoC Integration', 'ATOM51', 'AMBA APB3', 'OpenTitan'], outcome: 'Integration-ready IP, subsystem and SoC delivery', evidenceStatus: 'ready-to-populate',
    evidence: [
      { title: 'Tarang SoC — Architecture and Verification Specification', type: 'architecture', description: '8051-class SoC architecture and software-driven verification environment covering the ATOM51 CPU, 32 kB SRAM, AMBA APB3 subsystem, 15 peripheral instances, mailbox handshake, self-checking firmware and a 120-test regression.', href: '/evidence/tarang-soc-architecture-and-verification' },
      { title: 'OpenTitan Earl Grey — Secure SoC Verification', type: 'case-study', description: 'Representative secure-SoC verification evidence covering RTL/UVM/SystemVerilog, formal verification, life-cycle and reset verification, power/reset/control checks, cryptography verification and coverage/regression analysis.', href: '/evidence/opentitan-earl-grey-secure-soc-verification' },
    ],
  },
];
