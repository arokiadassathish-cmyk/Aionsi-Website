...
export const capabilities: Capability[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      { title: 'Advanced SoC Physical Design Case Study', type: 'case-study', description: 'Public AionSi case study covering multi-hierarchical SoC implementation, power islands, clock-tree engineering, physical constraints and flip-chip integration.', href: 'https://aionsi.com/case-study/advanced-soc-physical-design-case-study-2' },
      { title: 'Analog Layout & Physical Verification Case Study', type: 'case-study', description: 'Public AionSi case study covering turnkey analog layout, extraction-flow migration, DRC/LVS/DFM verification and constrained-area implementation.', href: 'https://aionsi.com/case-study/layout-and-design-case-study-1-' },
    ],
  },
  {
    slug: 'dft', number: '04', title: 'DFT', description: 'Design-for-test engineering integrated into the silicon lifecycle.', technologies: ['Test Architecture', 'Scan', 'ATPG'], outcome: 'Manufacturing-test readiness', evidenceStatus: 'ready-to-populate', evidence: [{ title: 'DFT Sign-off Methodology for Mixed-Signal IP', type: 'whitepaper', description: 'Scan chain debugging, ATPG pattern generation, fault coverage, Gate-Level Simulation, IEEE 1149.x boundary scan, CTL generation and DFT sign-off methodology.' }],
  },
  { slug: 'protocol-verification', number: '05', title: 'Protocol Verification', description: 'Protocol-focused verification for complex semiconductor interfaces.', technologies: ['PCIe', 'USB', 'DDR', 'HBM', 'AMBA/AXI'], outcome: 'Interface-level verification confidence', evidenceStatus: 'ready-to-populate' },
  { slug: 'soc-ip', number: '06', title: 'SoC & IP Engineering', description: 'Engineering across IP integration, subsystem development and SoC integration.', technologies: ['IP', 'Subsystem', 'SoC Integration'], outcome: 'Integration-ready IP, subsystem and SoC delivery', evidenceStatus: 'ready-to-populate' },
];
