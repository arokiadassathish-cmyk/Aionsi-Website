...
export const capabilities: Capability[] = [
  ...
  },
  {
    ...
    technologies: ['PCIe 5/6', 'USB 3.0 / USB4', 'DDR5 / LPDDR6', 'HBM4e', 'AMBA', 'UFS', 'MIPI', 'Ethernet'],
    outcome: 'Protocol compliance and interface verification confidence',
    evidenceStatus: 'ready-to-populate',
    evidence: [
      { title: 'Reusable Protocol Verification Architecture', type: 'whitepaper', description: 'Reference UVM methodology combining protocol-aware stimulus, reusable agents, monitors, scoreboards, predictors, assertions, coverage and regression analysis.', href: '/evidence/reusable-protocol-verification-architecture' },
      { title: 'PCIe 5.0 / 6.0 Protocol Verification', type: 'whitepaper', description: 'Protocol verification focus covering transaction and data-link behavior, replay, flow control, error injection, assertions and coverage for high-speed PCIe programs.', href: '/evidence/pcie-protocol-verification' },
      { title: 'USB 3.0 / USB4 Protocol Verification', type: 'whitepaper', description: 'AionSi flyer-backed scope covering packet-layer and link-management verification, error recovery, flow control, compliance scenarios, reusable UVM VIP and interoperability verification.', href: '/evidence/usb4-protocol-verification' },
      { title: 'DDR5 / LPDDR6 Memory Interface Verification', type: 'whitepaper', description: 'AionSi flyer-backed scope covering memory interface verification, timing compliance, command sequencing, DFI/protocol verification, multi-channel synchronization, checkers, assertions, coverage and regression/debug.', href: '/evidence/ddr5-lpddr6-protocol-verification' },
      { title: 'HBM4e Memory Subsystem Verification', type: 'whitepaper', description: 'AionSi flyer-backed scope covering JEDEC-compliant multi-channel interface verification, training, calibration, PHY timing alignment, error handling and reliability validation.', href: '/evidence/hbm4e-protocol-verification' },
